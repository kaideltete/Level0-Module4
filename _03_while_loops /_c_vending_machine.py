...
if __name__ == '__main__':
 ...
 # TODO) Call the vending_machine() function and save the money spent
        ...
        if money_spent == 0:
            messagebox.showinfo(message=str(money_in_dollars))
            break
    ...
    if money_in_dollars == 0.00:
        messagebox.showinfo(message="you maximised your money,good job!")
    # TODO) If there is a negative amount of money, tell the user they
    #  overspent!
    if money_in_dollars < 0.00:
        messagebox.showinfo(message="you overspent!")
